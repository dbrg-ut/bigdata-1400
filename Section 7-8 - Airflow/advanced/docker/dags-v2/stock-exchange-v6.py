...
EXCEL_FILE_NAME= Variable.get('EXCEL_FILE_NAME')
EXCEL_FILE_EXT_XLSX = Variable.get('EXCEL_FILE_EXT_XLSX')
EXCEL_FILE_EXT_CSV = Variable.get('EXCEL_FILE_EXT_CSV')
EXCEL_FILE_PATH = Variable.get('EXCEL_FILE_PATH')
HDFS_CSV_FOLDER = Variable.get('HDFS_CSV_FOLDER')
...
default_args = {
    ...
    'start_date': utils.dates.days_ago(20), 
...
dag = DAG("Stock-Exchange-V6", default_args=default_args, schedule_interval="0 13 * * 6,0-3" , catchup=True );
